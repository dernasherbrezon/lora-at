...
void test_at_util_string2hex_allocated() {
...
int main(void) {
  UNITY_BEGIN();
  RUN_TEST(test_at_util_string2hex);
  RUN_TEST(test_at_util_string2hex_allocated);
  RUN_TEST(test_at_util_hex2string);
  RUN_TEST(test_at_util_vector);
  exit(UNITY_END());
}