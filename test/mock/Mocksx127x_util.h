...
#define lora_util_get_min_frequency_IgnoreAndReturn(cmock_retval) lora_util_get_min_frequency_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void lora_util_get_min_frequency_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint64_t cmock_to_return);
#define lora_util_get_min_frequency_StopIgnore() lora_util_get_min_frequency_CMockStopIgnore()
void lora_util_get_min_frequency_CMockStopIgnore(void);
#define lora_util_get_min_frequency_ExpectAndReturn(cmock_retval) lora_util_get_min_frequency_CMockExpectAndReturn(__LINE__, cmock_retval)
void lora_util_get_min_frequency_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, uint64_t cmock_to_return);
typedef uint64_t (* CMOCK_lora_util_get_min_frequency_CALLBACK)(int cmock_num_calls);
...
#define lora_util_get_min_frequency_StubWithCallback lora_util_get_min_frequency_Stub
#define lora_util_get_max_frequency_IgnoreAndReturn(cmock_retval) lora_util_get_max_frequency_CMockIgnoreAndReturn(__LINE__, cmock_retval)
void lora_util_get_max_frequency_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, uint64_t cmock_to_return);
#define lora_util_get_max_frequency_StopIgnore() lora_util_get_max_frequency_CMockStopIgnore()
void lora_util_get_max_frequency_CMockStopIgnore(void);
#define lora_util_get_max_frequency_ExpectAndReturn(cmock_retval) lora_util_get_max_frequency_CMockExpectAndReturn(__LINE__, cmock_retval)
void lora_util_get_max_frequency_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, uint64_t cmock_to_return);
typedef uint64_t (* CMOCK_lora_util_get_max_frequency_CALLBACK)(int cmock_num_calls);
...
#define lora_util_get_max_frequency_StubWithCallback lora_util_get_max_frequency_Stub
